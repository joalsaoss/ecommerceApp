		...
		result = categoryServiceRepo.save(category) != null
				...
				: new CategoryDTO() {
					...
					public void setMsgresponse(String msgresponse) {
						super.setMsgresponse(EcommMessages.getMessage(EcommConstants.MESSAGE_ERROR_CATEGORY_CREATE,
								MessageEnum.ERRORS, ""));
					};
				};
		return result;
	...
	public ProductDTO createProduct(ProductDTO productDTO) throws EcommException {
		...
		result = productServiceRepo.save(product) != null ? productMapper.productEntityToDTO(product)
				: new ProductDTO() {
					...
					public void setMsgresponse(String msgresponse) {
						super.setMsgresponse(EcommMessages.getMessage(EcommConstants.MESSAGE_ERROR_PRODUCT_CREATE,
								MessageEnum.ERRORS, ""));
					};
				};
		return result;
